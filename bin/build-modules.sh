...
CURR_DIR=`pwd`
BASE_DIR=$CURR_DIR/target/pfp/modules
...
ORIGINAL_IFS=$IFS
WORKBENCH_WEBAPP_NAME="bpms-pfp"
...
#Copy not modularized jars back to WEB-INF lib
mv $JARS_DIR/$WORKBENCH_WEBAPP_NAME/*.jar $WAR_DIR/$WORKBENCH_WEBAPP_NAME/WEB-INF/lib
