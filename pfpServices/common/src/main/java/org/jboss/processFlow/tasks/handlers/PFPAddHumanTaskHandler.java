...
public class PFPAddHumanTaskHandler extends BasePFPTaskHandler implements WorkItemHandlerLifecycle {
    ...
    public void executeWorkItem(WorkItem workItem, WorkItemManager manager) {
        ...
        User adminUser = new User(ITaskService.ADMINISTRATOR);
        ...
        task.setDeadlines(HumanTaskHandlerHelper.setDeadlines(workItem, businessAdministrators, super.ksession.getEnvironment()));
