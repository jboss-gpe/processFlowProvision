...
/*
 * JA Bride
 * temporarily copied over from jbpm-kie-services/src/main/java/org/jbpm/kie/services/impl/VFSDeploymentService.java
 * until i figure out how to provide visibility to CDI container of a bean that is deployed as a JBoss Module
*/
