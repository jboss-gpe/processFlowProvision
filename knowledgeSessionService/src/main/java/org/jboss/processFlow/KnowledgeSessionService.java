...
@RemoteBinding(jndiBinding="KnowledgeSessionService/remote")
@Service (objectName="org.jboss.processFlow.knowledgeService:service=KnowledgeSessionService")
@Management(IKnowledgeSessionService.class)
@TransactionAttribute(TransactionAttributeType.REQUIRED)
public class KnowledgeSessionService implements IKnowledgeSessionService {
 ...
 **************        Singleton Lifecycle Management                     *********/
    ...
    public void start() throws Exception {
        ...
        // 3)  lookup a reference to the TransactionManager
 ...
 *************              Process Instance Management              *********/
    ...
    private void rollbackTrnx() {
        try {
            if(tMgr.getStatus() == javax.transaction.Status.STATUS_ACTIVE)
                tMgr.rollback();
        }catch(Exception e) {
            e.printStackTrace();
        }
