...
public interface ITaskService {
    ...
    public static final String TASK_SERVICE_JNDI = "TaskService/remote";
     ...
     *getKsessionId
     *<pre>
     *- the 'task' table of jbpm5/BRMS does inclue the following two fields
     *      1)  processinstanceid
     *      2)  processsessionid
     *- for those implementations adhering to a 'process instance per ksession' architecture, this mapping between 
     *  processInstanceId and ksessionId is important
     *
     *- will throw a TaskException if no task record with a given processInstanceId is found
     *</pre>
     */
